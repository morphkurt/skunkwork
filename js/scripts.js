...
d3.json(url, function(data) {
  ...
  var tip = d3.tip()
    ...
    .offset([-10, 0])
    .html(function(d) {
      return "<strong>Weekly Distance:</strong> <span style='color:red'>" + d.totaldistance + "</span></br><strong>Runs:</strong> <span style='color:red'>" + d.count + "</span>";
    })

  var svg = d3.select("#weeklyRuns").append("svg")
